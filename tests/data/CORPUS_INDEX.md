...
|---|----------|----------|--------|---------|-------|
| 01 | he_01_sentence_token_lemma_basics | Базовое разбиение предложений, токенизация и лемматизация | 6 | any | metallurgy / materials engineering |
| 02 | he_02_noise_and_borderline | Noise and borderline cases | 8 | any | noise filtering |
| 03 | he_03_docfreq_crossdoc | Document frequency across documents | 4 | any | metallurgy |
| 04 | he_04_ngram_np_patterns | N-gram and NP patterns | 4 | any | metallurgy |
| 05 | he_05_terms_balanced | Balanced term extraction | 3 | balanced | engineering |
| 06 | he_06_terms_recall_hapax | Recall-oriented with hapax | 2 | recall | engineering |
| 07 | he_07_terms_precise | Precise term extraction | 2 | precise | engineering |
| 08 | he_08_tm_projection_candidates | TM projection candidates | 2 | balanced | engineering |
| 09 | he_09_mixed_domain_materials | Mixed domain with noise | 3 | balanced | mixed |
